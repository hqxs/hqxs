				...
				<span class="ctrl">
					<a class="tab_link" href="http://www.haodou.com/cook-10673352/">
						<span class="inner">
							...
							<span class="angle_down">sjason991</span><i class="ico12 arrdown">&nbsp;</i>
						</span>
					</a>
				</span>
                <div class="sub_box">
    ...
    <div class="shell_mc clearfix">
        <div class="area_main">
            ...
            <div class="clearfix mgt20">
                <h3 class="pub_title">选择小组</h3>
                <div class="sele">
                    <div>
                        <select name=""  id="group_cat">
                            @foreach($data as $v)
                            @if($v->cate_pid==0)
                ...
                <div class="sele">
                    <div>
                        <select name="art_xz"  id="group_sub_cat">
                            @foreach($data as $v)
                                @if($v->cate_pid==1)
                                    <option value={{$v->cate_id}}>{{$v->cate_name}}</option>
                                @endif
                    ...
                    $('#group_cat').change(function(){
                        ...
                        $.ajax({
                            ...
                            success:function(data){
                                ...
                                for(var key in data)
                                {
                                    html += "<option value="+ data[key].cate_id +">"+ data[key].cate_name +"</option>";
                                }
                                $("#group_sub_cat").html(html);
                            },
                            dataType:'json'
                        })
                    })
            ...
            @endif
            <div>
                <input class="title_input" style="float: left;  margin-right: 10px;" name="art_title" id="title" value="" placeholder="请输入标题" type="text" maxlength="20">
            ...
            <divs>
                ...
                <script id="editor" name="art_content" type="text/plain" style="width:661px;height:500px;"></script>
                <script type="text/javascript">
                    var ue = UE.getEditor('editor');
                </script>
            </divs>
            <h3 class="main_t ft14 mgt20">标签</h3>
            <input class="title_input" name="art_tag" id="tags" value="" placeholder="在此输入标签，多个标签之间请用空格隔开" type="text">
            ...
            <div class="area_auto mgt10">
                ...
                <a class="btn_basic btn_h mgr10 topic_publish_btn" id="save_draf_btn" href="javascript:///" title="保存到草稿箱">保存到草稿箱</a>                <span class="ie6hack">&nbsp;</span>
            </div>
