                    ...
                    @section('nav-list')
                        <ul class="nav nav-list">
                                ...
                                <ul class="submenu">
                                    <li>
                                        ...
                                        <ul class="submenu">
                                            ...
                                            <li>
                                                <a href="{{url('/admin/secondcate')}}" class="dropdown-toggle">
                                            ...
                                            <li>
                                                <a href="{{url('/admin/thirdcate')}}" class="dropdown-toggle">
                                                    <i class="icon-pencil"></i>
                                                    三级分类
                                                </a>
                                            </li>
                                    ...
                                    <li>
                                        <a href="{{url('admin/addr')}}" class="dropdown-toggle">
                                            <i class="icon-double-angle-right"></i>
                                            订单地址
                                        </a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul class="submenu">
                                    <li>
                                        <a href="{{url('admin/cookbook/list')}}">
                                            <i class="icon-double-angle-right"></i>
                                            添加分类
                                        </a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul class="submenu">
                                    <li>
                                        <a href="{{url('admin/food/foodcate')}}">
                                            <i class="icon-double-angle-right"></i>
                                            添加食材分类
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{url('admin/food/foodadd')}}">
                                            <i class="icon-double-angle-right"></i>
                                            添加食材
                                        </a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul class="submenu">
                                    ...
                                    <li>
                                        <a href="{{url('admin/comment/up')}}" class="dropdown-toggle">
                                            <i class="icon-pencil"></i>
                                            话题审核
                                            {{--<b class="arrow icon-angle-down"></b>--}}
                                        </a>
...
@section('js')
    ...
    <!-- basic scripts -->
    <script src="/js/admin/jquery-2.0.3.min.js"></script>
    <script type="text/javascript">
