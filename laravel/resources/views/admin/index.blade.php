                    ...
                    <ul class="nav ace-nav">
                        ...
                        <li class="green">
                            ...
                            <ul class="pull-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
                                ...
                                <li>7
                                    <a href="#">
                                        <img src="/images/admin/avatar.png" class="msg-photo" alt="Alex's Avatar" />
                                        <span class="msg-body">
                                ...
                                <li>
                                    <a href="#">
                                        <img src="/images/admin/avatar3.png" class="msg-photo" alt="Susan's Avatar" />
                                        <span class="msg-body">
                                                <span class="msg-title">
                                ...
                                <li>
                                    <a href="#">
                                        <img src="/images/admin/avatar4.png" class="msg-photo" alt="Bob's Avatar" />
                                        <span class="msg-body">
                                                <span class="msg-title">
        ...
        <div class="main-container" id="main-container">
            ...
            @section('main-container-inner')
                <div class="main-container-inner">
                                    ...
                                    <ul class="submenu">
                                        <li>
                                            ...
                                            <ul class="submenu">
                                                ...
                                                <li>
                                                    <a href="{{url('/admin/catetory')}}" class="dropdown-toggle">
                                                        <i class="icon-pencil"></i>
                                                        编辑类别
                                                        {{--<b class="arrow icon-angle-down"></b>--}}
                                                    </a>                   
                                        ...
                                        <li>
                                            ...
                                            <ul class="submenu">
                                                ...
                                                <li>
                                                    <a href="{{url('admin/goods/list')}}" class="dropdown-toggle">
                                                        <i class="icon-pencil"></i>
                                                        编辑商品
                                                        {{--<b class="arrow icon-angle-down"></b>--}}
                                                    </a>
                                            ...
                                            <ul class="submenu">
                                                ...
                                                <li>
                                                    <a href="{{url('admin/goods/image')}}" class="dropdown-toggle">
                                                        <i class="icon-pencil"></i>
                                                        编辑图集
                                                        {{--<b class="arrow icon-angle-down"></b>--}}
                                                    </a>
                                                            ...
                                                            <div class="tab-content padding-8 overflow-visible">
                                                                ...
                                                                <div id="member-tab" class="tab-pane">
                                                                    <div class="clearfix">
                                                                        ...
                                                                        <div class="itemdiv memberdiv">
                                                                            <div class="user">
                                                                                <img alt="Joe Doe's avatar" src="/images/admin/avatar2.png" />
                                                                            </div>
                                                                        ...
                                                                        <div class="itemdiv memberdiv">
                                                                            <div class="user">
                                                                                <img alt="Jim Doe's avatar" src="/images/admin/avatar.png" />
                                                                            </div>
                                                                        ...
                                                                        <div class="itemdiv memberdiv">
                                                                            <div class="user">
                                                                                <img alt="Alex Doe's avatar" src="/images/admin/avatar5.png" />
                                                                            </div>
                                                                        ...
                                                                        <div class="itemdiv memberdiv">
                                                                            <div class="user">
                                                                                <img alt="Bob Doe's avatar" src="/images/admin/avatar2.png" />
                                                                            </div>
                                                                        ...
                                                                        <div class="itemdiv memberdiv">
                                                                            <div class="user">
                                                                                <img alt="Susan's avatar" src="/images/admin/avatar3.png" />
                                                                            </div>
                                                                        ...
                                                                        <div class="itemdiv memberdiv">
                                                                            <div class="user">
                                                                                <img alt="Phil Doe's avatar" src="/images/admin/avatar4.png" />
                                                                            </div>
                                                                        ...
                                                                        <div class="itemdiv memberdiv">
                                                                            <div class="user">
                                                                                <img alt="Alexa Doe's avatar" src="/images/admin/avatar1.png" />
                                                                            </div>
                                                                ...
                                                                <div id="comment-tab" class="tab-pane">
                                                                    <div class="comments">
                                                                        ...
                                                                        <div class="itemdiv commentdiv">
                                                                            <div class="user">
                                                                                <img alt="Jennifer's Avatar" src="/images/admin/avatar1.png" />
                                                                            </div>
                                                                        ...
                                                                        <div class="itemdiv commentdiv">
                                                                            <div class="user">
                                                                                <img alt="Joe's Avatar" src="/images/admin/avatar2.png" />
                                                                            </div>
                                                                        ...
                                                                        <div class="itemdiv commentdiv">
                                                                            <div class="user">
                                                                                <img alt="Rita's Avatar" src="/images/admin/avatar3.png" />
                                                                            </div>
                                                        ...
                                                        <div class="widget-main no-padding">
                                                            <div class="dialogs">
                                                                <div class="itemdiv dialogdiv">
                                                                    <div class="user">
                                                                        <img alt="Alexa's Avatar" src="/images/admin/avatar1.png" />
                                                                    </div>
                                                                ...
                                                                <div class="itemdiv dialogdiv">
                                                                    <div class="user">
                                                                        <img alt="John's Avatar" src="/images/admin/avatar.png" />
                                                                    </div>
                                                                ...
                                                                <div class="itemdiv dialogdiv">
                                                                    <div class="user">
                                                                        <img alt="Bob's Avatar" src="/images/admin/user.jpg" />
                                                                    </div>
                                                                ...
                                                                <div class="itemdiv dialogdiv">
                                                                    <div class="user">
                                                                        <img alt="Jim's Avatar" src="/images/admin/avatar4.png" />
                                                                    </div>
                    ...
                    @section('ace-settings-container')
...
@section('js')
    ...
    <script src="/js/admin/jquery.easy-pie-chart.min.js"></script>
